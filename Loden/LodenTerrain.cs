...
namespace org.herbal3d.Loden {
    public class LodenTerrain {

        private static readonly string LogHeader = "LodenTerrain";

        // Create a mesh for the terrain of the current scene
        public static async Task<GltfNode> CreateTerrainMesh(LodenContext context,
                            Scene scene,
